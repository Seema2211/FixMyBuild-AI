  ...
  return (
    <section className="py-24 lg:py-32">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="text-xs font-semibold uppercase tracking-widest text-indigo-400 mb-3">FAQ</div>
            ...
            >
              <button
                ...
                className={cn(
                  ...
                  open === i
                    ? 'bg-white/6 border-indigo-500/30'
                    : 'bg-white/3 border-white/8 hover:border-white/15 hover:bg-white/5'
                )}
              >
                <span className="flex-1 text-sm font-semibold text-white mt-0.5">{item.q}</span>
                <ChevronDown
                  className={cn(
              ...
              <AnimatePresence>
                {open === i && (
                  ...
                  >
                    <div className="px-5 pb-4 pt-2 text-sm text-slate-400 leading-relaxed">
                      {item.a}
                    </div>
                  </motion.div>
                )}
