...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: 'website',
    locale: 'en_US',
    url: 'https://fixmybuild.io',
    siteName: 'FixMyBuild',
    title: 'FixMyBuild — AI-Powered CI/CD Failure Analysis',
    description:
      'Stop debugging CI/CD failures manually. FixMyBuild uses AI to analyze, explain, and automatically fix pipeline failures across GitHub, GitLab, and Azure DevOps.',
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" className={`${geistSans.variable} ${geistMono.variable} h-full`}>
      <body className="min-h-full flex flex-col bg-[#07070f] text-slate-50 antialiased">
        {children}
      </body>
    </html>
  );
