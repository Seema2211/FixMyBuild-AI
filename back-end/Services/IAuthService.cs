...
public record UserDto(Guid Id, string Email, string FirstName, string LastName, Guid OrganizationId, string OrganizationName, string Role, bool EmailVerified = false);
