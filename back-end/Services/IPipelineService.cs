...
public interface IPipelineService
{
    ...
    Task<PipelinePage> GetAllFailuresAsync(string? search = null, string? severity = null, int page = 1, int pageSize = 20, Guid? orgId = null, CancellationToken cancellationToken = default);
